...
public class OwnerRestController {
	...
	public ResponseEntity<OwnerDto> findById(@PathVariable Integer id) {
		...
		return ResponseEntity.ofNullable(ownerMapper.toDto(owner));
	}
	...
	@PutMapping("/{id}")
	@ResponseStatus(HttpStatus.OK)
	public OwnerDto update(@PathVariable Integer id, @RequestBody @Valid OwnerDto ownerDto) {
		Owner existingOwner = ownerRepository.findById(id);
		ownerMapper.update(ownerDto, existingOwner);
